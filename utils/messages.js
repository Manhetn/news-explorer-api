const messages = {
  ...
  article: {
    ...
    title: {
      ...
      maxLength: "title должно содержать не более 100 символов",
    },
    text: {
    ...
    date: {
      ...
      minLength: `date должно содержать не менее 8 символов, желатеьно в формате: 01 месяц, 2020`,
    ...
    link: {
      empty: "link статью обязательное поле",
      uri:
    ...
    id: {
      length: "Идетификатор статьи должен состоять из 24 симолов",
    },
  },
  authorization: {
